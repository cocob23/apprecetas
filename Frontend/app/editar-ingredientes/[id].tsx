...
export default function EditarIngredientesScreen() {
  ...
  useEffect(() => {
    const cargarIngredientes = async () => {
      try {
        const res = await axios.get('http://192.168.0.232:8081/ingredientes');
...
const agregarIngrediente = async () => {
  try {
    ...
    if (!encontrado) {
      const resNuevo = await axios.post('http://192.168.0.232:8081/ingredientes/crear', {
    ...
    await axios.post('http://192.168.0.232:8081/recetas/agregar-ingrediente', {
      recetaId,
